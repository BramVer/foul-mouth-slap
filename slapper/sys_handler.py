...
def _halt_and_wait_for_input(violations: list):
...
def handle_violations_and_exit(violations: list):
  '''Purely an exposed def to put the process in better context.'''
  _halt_and_wait_for_input(violations)